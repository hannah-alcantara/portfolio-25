      ...
      <section className='bg-purple px-6 py-20 text-white relative overflow-hidden'>
        <div className='max-w-4xl mx-auto flex items-center justify-between'>
          <div className='max-w-lg'>
            ...
            <p className='text-lg mb-6 leading-relaxed'>
              I was formerly a graphic designer, I love to bring a unique blend
              of creativity and technical expertise to my work.
            </p>
            <p className='text-lg leading-relaxed'>
              In my free time, I enjoy crocheting, watching films, and exploring
              new technologies
            </p>
          </div>
          ...
          <div className='relative'>
            ...
            {/* Decorative stars */}
            <div className='absolute -top-8 -left-8 text-yellow-300 text-2xl'>
              ✦
            </div>
            <div className='absolute -bottom-8 -right-8 text-yellow-300 text-xl'>
              ✦
            </div>
          </div>
        </div>
